...
//const { agregarProductoSocket } = require('./controllers/productos');
const { emitirProductosSocket, agregarProductoSocket } = require('./controllers/productos.controller');
//const { emitirMensajesSocket, agregarMensajeSocket } = require('./controllers/foros');
const { emitirMensajesSocket, agregarMensajeSocket } = require('./controllers/foros.controller');
